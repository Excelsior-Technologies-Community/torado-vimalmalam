                ...
                <nav className="sidebar-nav">
                    ...
                    <Link to="/testimonials" className="nav-item">
                        <svg
                            ...
                            strokeLinejoin="round"
                        >
                            <path d="M3 21c3-6 6-8 10-8s7 2 8 8" />
                            <path d="M7 10V7a3 3 0 0 1 6 0v3" />
                        </svg>

                        Testimonials
                    </Link>
                    <Link to="/process" className="nav-item">
                        <svg
                            width="18"
                            height="18"
                            viewBox="0 0 24 24"
                    ...
                    <Link to="/allservices" className="nav-item">
                        <svg
                            width="18"
                            height="18"
                            viewBox="0 0 24 24"
